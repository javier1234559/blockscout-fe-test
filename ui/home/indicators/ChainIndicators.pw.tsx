...
//       '["daily_txs","coin_price","secondary_coin_price","market_cap","tvl"]',
//     ],
...
//   test.beforeEach(
//     async ({ page, mockApiResponse, mockAssetResponse, render }) => {
...
//         statsMock.withSecondaryCoin.coin_image as string,
...
//         return (
//           document
//             .querySelector('path[data-name="gradient-chart-area"]')
...
//   await mockAssetResponse(
//     statsMock.base.coin_image as string,
...
//   await mockAssetResponse(
//     statsMock.noChartData.coin_image as string,
//     "./playwright/mocks/image_s.jpg"
//   );
