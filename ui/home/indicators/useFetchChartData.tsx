...
export default function useFetchChartData<R extends ChartsResources>(
  ...
  const queryResult = useApiQuery("stats_charts_txs", {
    queryOptions: { enabled: Boolean(indicator) },
  });
  ...
  return React.useMemo(() => {
    return {
      ...queryResult,
      data:
        queryResult.data && indicator
          ? indicator.api.dataFn(queryResult.data as ResourcePayload<R>)
          : queryResult.data,
    } as unknown as UseQueryResult<TimeChartData>;
