...
const DEFAULT_TEMPLATE =
  "STO CHAIN is an institutional-grade permissioned blockchain built specifically for regulated assets. It streamlines antiquated processes and opens the door to new financial instruments by solving the challenges around governance, identity, compliance, confidentiality, and settlement.";
...
const TEMPLATE_MAP: Record<Route["pathname"], string> = {
  ...
  "/uncles": DEFAULT_TEMPLATE,
  "/reorgs": DEFAULT_TEMPLATE,
};
